...
const EXERCISE_LIBRARY = [
  {name:'Wyciskanie hantli na ławce płaskiej', muscle:'Klatka', equipment:'Hantle', category:'press', imageSrc:'eximg/db_flat_press.png', sets:3,min:8,max:12,step:2,note:'Łopatki lekko ściągnięte; łokcie ok. 30–45°.'},
  {name:'Wyciskanie hantli na podłodze', muscle:'Klatka', equipment:'Hantle', category:'press', imageSrc:'eximg/db_flat_press.png', sets:3,min:8,max:12,step:2,note:'Podłoga ogranicza głębokość i rozciągnięcie barku.'},
  {name:'Chest press na maszynie — chwyt neutralny', muscle:'Klatka', equipment:'Maszyna', category:'press', imageSrc:'eximg/chestpress_machine.png', sets:3,min:8,max:12,step:5,note:'Nie wysuwaj barków do przodu przy końcu serii.'},
  {name:'Rozpiętki na wyciągu na wysokości klatki', muscle:'Klatka', equipment:'Wyciąg', category:'fly', imageSrc:'eximg/cable_fly.png', sets:2,min:12,max:15,step:2.5,note:'Lekko ugięte łokcie, kontrolowany zakres.'},
  {name:'Rozpiętki high-to-low na wyciągu', muscle:'Klatka', equipment:'Wyciąg', category:'fly', imageSrc:'eximg/cable_fly.png', sets:2,min:12,max:15,step:2.5,note:'Dół i środek klatki; prowadź dłonie w dół i do środka.'},
  {name:'Rozpiętki low-to-high na wyciągu', muscle:'Klatka', equipment:'Wyciąg', category:'fly', imageSrc:'eximg/cable_fly.png', sets:2,min:12,max:15,step:2.5,note:'Górna część klatki; nie unoś barków.'},
  {name:'Pompki na uchwytach / podwyższeniu', muscle:'Klatka', equipment:'Masa ciała', category:'press', imageSrc:'eximg/db_flat_press.png', sets:3,min:8,max:15,step:1,note:'Dobierz wysokość tak, aby bark był spokojny.'},
  ...
  {name:'Unoszenie bokiem na maszynie', muscle:'Barki', equipment:'Maszyna', category:'latraise', imageSrc:'eximg/lateral_raise_cable.png', sets:3,min:12,max:20,step:2.5,note:'Płynny ruch, bez szarpania.'},
  ...
  {name:'Reverse pec deck', muscle:'Barki', equipment:'Maszyna', category:'rear', imageSrc:'eximg/reverse_pec_deck.png', sets:3,min:12,max:20,step:2.5,note:'Stabilny tułów, bez unoszenia barków do uszu.'},
  {name:'Face pull z liną', muscle:'Barki', equipment:'Wyciąg', category:'rear', imageSrc:'eximg/face_pull.png', sets:2,min:12,max:20,step:2.5,note:'Lekko, kontrolowanie; lina w kierunku twarzy.'},

  {name:'Ściąganie uchwytu neutralnego do klatki', muscle:'Plecy', equipment:'Wyciąg', category:'pulldown', imageSrc:'eximg/lat_pulldown.png', sets:3,min:8,max:12,step:5,note:'Bez bujania tułowiem.'},
  {name:'Ściąganie drążka jednorącz', muscle:'Plecy', equipment:'Wyciąg', category:'pulldown', imageSrc:'eximg/lat_pulldown.png', sets:3,min:10,max:15,step:2.5,note:'Łokieć prowadź w dół, bez skręcania.'},
  {name:'Wiosłowanie hantlem z podparciem', muscle:'Plecy', equipment:'Hantle', category:'row', imageSrc:'eximg/chest_supported_row.png', sets:3,min:8,max:12,step:2,note:'Nie skręcaj tułowia.'},
  {name:'Wiosłowanie hantlami z klatką opartą', muscle:'Plecy', equipment:'Hantle', category:'row', imageSrc:'eximg/seated_row.png', sets:3,min:10,max:15,step:2,note:'Klatka oparta, bez bujania.'},
  ...
  {name:'Wiosłowanie na maszynie z podparciem klatki', muscle:'Plecy', equipment:'Maszyna', category:'row', imageSrc:'eximg/seated_row.png', sets:3,min:8,max:12,step:5,note:'Stabilny tułów, łokcie prowadzą ruch.'},
  {name:'Straight-arm pulldown', muscle:'Plecy', equipment:'Wyciąg', category:'pulldown', imageSrc:'eximg/lat_pulldown.png', sets:2,min:12,max:15,step:2.5,note:'Ramiona prawie proste, ruch z barku.'},

  {name:'Uginanie młotkowe hantli', muscle:'Biceps', equipment:'Hantle', category:'biceps', imageSrc:'eximg/hammer_curl.png', sets:3,min:10,max:15,step:2,note:'Nadgarstki neutralnie.'},
  {name:'Uginanie ramion na wyciągu', muscle:'Biceps', equipment:'Wyciąg', category:'biceps', imageSrc:'eximg/hammer_curl.png', sets:2,min:10,max:15,step:2.5,note:'Bez bujania tułowiem.'},
  ...
  {name:'Prostowanie jednorącz na wyciągu', muscle:'Triceps', equipment:'Wyciąg', category:'triceps', imageSrc:'eximg/rope_pushdown.png', sets:2,min:10,max:15,step:1.25,note:'Lekki ciężar, pełna kontrola.'},
  {name:'Prostowanie na maszynie triceps', muscle:'Triceps', equipment:'Maszyna', category:'triceps', imageSrc:'eximg/rope_pushdown.png', sets:2,min:10,max:15,step:2.5,note:'Nie unoś barków do uszu.'},

  {name:'Hip thrust', muscle:'Pośladki', equipment:'Maszyna', category:'hipthrust', imageSrc:'eximg/hip_thrust.png', sets:4,min:8,max:12,step:5,note:'Pauza 1 s u góry, napnij pośladki.'},
  {name:'Glute bridge na maszynie', muscle:'Pośladki', equipment:'Maszyna', category:'hipthrust', imageSrc:'eximg/hip_thrust.png', sets:3,min:10,max:15,step:5,note:'Nie przeprostowuj lędźwi.'},
  {name:'Cable pull-through', muscle:'Pośladki', equipment:'Wyciąg', category:'hinge', imageSrc:'eximg/pallof_press.png', sets:3,min:10,max:15,step:5,note:'Biodra do tyłu, pośladki prowadzą ruch.'},
  {name:'Martwy ciąg rumuński z hantlami', muscle:'Pośladki', equipment:'Hantle', category:'hinge', imageSrc:'eximg/rdl_db.png', sets:3,min:8,max:10,step:2,note:'Plecy neutralne, biodra do tyłu.'},
  {name:'Odwodzenie nóg na maszynie', muscle:'Pośladki', equipment:'Maszyna', category:'abduction', imageSrc:'eximg/hip_thrust.png', sets:3,min:15,max:20,step:2.5,note:'Bez odbijania ciężaru.'},
  {name:'Odwodzenie nogi na wyciągu', muscle:'Pośladki', equipment:'Wyciąg', category:'abduction', imageSrc:'eximg/hip_thrust.png', sets:3,min:15,max:20,step:1.25,note:'Stabilny tułów, mały kontrolowany ruch.'},

  {name:'Prostowanie nóg na maszynie — obie nogi', muscle:'Czworogłowe', equipment:'Maszyna', category:'legext', imageSrc:'eximg/leg_extension.png', sets:3,min:12,max:15,step:2.5,note:'Płynnie, bez kopania ciężaru.'},
  ...
  {name:'Izometryczne prostowanie kolana na maszynie', muscle:'Czworogłowe', equipment:'Maszyna', category:'legext', imageSrc:'eximg/leg_extension.png', sets:3,min:20,max:40,step:1.25,note:'Czas w sekundach; lekki opór.'},
  {name:'Łydki siedząc na maszynie', muscle:'Łydki', equipment:'Maszyna', category:'calf', imageSrc:'eximg/seated_calf.png', sets:3,min:12,max:20,step:5,note:'Pełen zakres ruchu i krótka pauza u góry.'},
  {name:'Pallof press', muscle:'Core', equipment:'Wyciąg', category:'core', imageSrc:'eximg/pallof_press.png', sets:2,min:10,max:15,step:2.5,note:'Na stronę; trzymaj brzuch napięty i nie rotuj tułowia.'},

  {name:'Uginanie nóg siedząc', muscle:'Tył uda', equipment:'Maszyna', category:'legcurl', imageSrc:'eximg/leg_curl.png', sets:3,min:10,max:15,step:2.5,note:'Kontrola i pauza przy zgięciu.'},
  {name:'Uginanie nóg leżąc', muscle:'Tył uda', equipment:'Maszyna', category:'legcurl', imageSrc:'eximg/leg_curl.png', sets:3,min:10,max:15,step:2.5,note:'Nie odrywaj bioder.'},
  {name:'Martwy ciąg rumuński z hantlami — tył uda', muscle:'Tył uda', equipment:'Hantle', category:'hinge', imageSrc:'eximg/rdl_db.png', sets:3,min:8,max:10,step:2,note:'Biodra do tyłu, plecy neutralne.'},

  {name:'Wspięcia na palce siedząc', muscle:'Łydki', equipment:'Maszyna', category:'calf', imageSrc:'eximg/seated_calf.png', sets:3,min:12,max:20,step:5,note:'Pauza u góry i pełna kontrola.'},
  {name:'Wspięcia na palce stojąc na maszynie', muscle:'Łydki', equipment:'Maszyna', category:'calf', imageSrc:'eximg/seated_calf.png', sets:3,min:12,max:20,step:5,note:'Nie odbijaj z dołu.'},

  {name:'Pallof press', muscle:'Core', equipment:'Wyciąg', category:'core', imageSrc:'eximg/pallof_press.png', sets:2,min:10,max:15,step:2.5,note:'Nie pozwól tułowiowi obracać się.'},
  {name:'Dead bug', muscle:'Core', equipment:'Masa ciała', category:'core', imageSrc:'eximg/pallof_press.png', sets:2,min:8,max:12,step:1,note:'Lędźwie stabilnie, ruch powoli.'},
  {name:'Deska bokiem', muscle:'Core', equipment:'Masa ciała', category:'core', imageSrc:'eximg/pallof_press.png', sets:2,min:20,max:40,step:1,note:'Czas w sekundach; ciało w jednej linii.'},
  {name:'Cable crunch', muscle:'Core', equipment:'Wyciąg', category:'core', imageSrc:'eximg/pallof_press.png', sets:2,min:10,max:15,step:2.5,note:'Zginaj tułów, nie ciągnij rękami.'}
];
...
function migratePlanData(){
  if(!data.plan){
    data.plan = structuredClone(DEFAULT_PLAN);
    return;
  }
  ['A','B','C'].forEach(day=>{
    data.plan[day] = normalizeDayPlan(data.plan[day] || []);
    const ids = new Set(data.plan[day].map(x=>x.id));
    DEFAULT_PLAN[day].forEach(def=>{
      if(!ids.has(def.id)) data.plan[day].push(structuredClone(def));
    });
    data.plan[day].forEach(ex=>{
      if(IMAGE_BY_NAME[ex.name]) ex.imageSrc = IMAGE_BY_NAME[ex.name];
    });
  });
}
